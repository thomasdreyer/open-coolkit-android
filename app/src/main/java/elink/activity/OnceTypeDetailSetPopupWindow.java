...
/**
 * Created by hezhiyong on 9/16/15.
 */
public class OnceTypeDetailSetPopupWindow extends PopupWindow {

    private static final String TAG = OnceTypeDetailSetPopupWindow.class.getSimpleName();
    ...
    public OnceTypeDetailSetPopupWindow(AddTimerActivity helper, View.OnClickListener itemsOnClick) {
        super(helper);
...
//        mMitutePicker = (TimePicker) mSetDetailView.findViewById(R.id.mMitutePicker);
        ...
        if (null != mAddTimerHelper.mDetailDatePick) {
            ...
            //用历史数据来初始化详细设置界面
            HLog.i(TAG,"mAddTimerHelper.mDate："+mAddTimerHelper.mDate);
            cal.setTime(mAddTimerHelper.mDate);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mAddTimerHelper.mDate = cal.getTime();
                mAddTimerHelper.showTVDate();

                dismiss();
            }
        });
        swp_quickview.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                dismiss();
