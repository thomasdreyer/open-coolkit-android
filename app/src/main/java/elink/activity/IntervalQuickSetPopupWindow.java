...
public class IntervalQuickSetPopupWindow extends PopupWindow{
    private static final String TAG = IntervalQuickSetPopupWindow.class.getSimpleName();
    ...
    public IntervalQuickSetPopupWindow(AddTimerActivity helper, View.OnClickListener itemsOnClick) {
        super(helper);
    ...
    private void initViewQuick() {
        ...
        swp_detailview.setText(mAddTimerHelper.getString(R.string.intervaltime));
    ...
    private void setview() {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mAddTimerHelper.mDay = mDayPicker.getValue();
                mAddTimerHelper.mHour = mHourPicker.getValue();
                mAddTimerHelper.mMinutes = mMitutePicker.getValue();
                Calendar cal = Calendar.getInstance();
                mAddTimerHelper.mIntervaltimeData = new Date(cal.getTime().getTime() + mDayPicker.getValue()* AlarmManager.INTERVAL_DAY+mHourPicker.getValue()*AlarmManager.INTERVAL_HOUR+ mMitutePicker.getValue() * AlarmManager.INTERVAL_FIFTEEN_MINUTES/15);
//                mAddTimerHelper.mIntervaltimeData = new Date(mDayPicker.getValue()* AlarmManager.INTERVAL_DAY+mHourPicker.getValue()*AlarmManager.INTERVAL_HOUR+ mMitutePicker.getValue() * AlarmManager.INTERVAL_FIFTEEN_MINUTES/15);
